...
export interface esp_Language extends IEntity {
  /*
  ...
  */
  ...
  /*
  BCP 47 Code StringType LCID - https://learn.microsoft.com/en-us/openspecs/office_standards/ms-oe376/6c085406-a698-4e12-9d4d-c3b0ee3dbc4a
  */
  esp_bcp47code?: string | null;
  /*
  Language [Required] StringType
  */
  esp_language?: string;
  /*
  Language UniqueidentifierType Unique identifier for entity instances
  */
  esp_languageid?: import("dataverse-ify").Guid | null;
  /*
  LCID [Required] StringType LCID - https://learn.microsoft.com/en-us/openspecs/office_standards/ms-oe376/6c085406-a698-4e12-9d4d-c3b0ee3dbc4a
  */
  esp_lcid?: string;
  /*
  ...
  */
  ...
  /*
  Status esp_language_esp_language_statecode Status of the Language
  */
  statecode?: import("../enums/esp_language_esp_language_statecode").esp_language_esp_language_statecode | null;
  /*
  Status Reason esp_language_esp_language_statuscode Reason for the status of the Language
  */
  statuscode?: import("../enums/esp_language_esp_language_statuscode").esp_language_esp_language_statuscode | null;
  /*
